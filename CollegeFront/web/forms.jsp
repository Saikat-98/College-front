...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Add a College</h2>
            <!--// main-heading -->
            ...
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Enter the details of college</h4>
                    <form action="AddServlet" method="post">
                        <div class="form-group">
                            <label for="inputAddress">College ID</label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="C1" name="ID" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress">College Name</label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="Chitkara University" name="Name" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">State</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="Himachal Pradesh" name="State" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">Cut-Off</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="9.8" name="Cutoff" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">Counselling Date(FROM)</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="26th June,2018" name="Datef" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">Counselling Date(TO)</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="26th June,2018" name="Datet" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputAddress2">Url</label>
                            <input type="url" class="form-control" id="inputAddress2" placeholder="chitkara.html" name="Url" required="">
                        </div>
                        <div class="form-group">
