                ...
                <div class="outer-w3-agile mt-3">
                    ...
                    <table class="table table-striped">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col" rowspan="2" style="text-align: center;vertical-align: middle;">College ID</th>
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <th scope="row" style="text-align: center;vertical-align: middle;"><%out.println(rs.getString(1));%></th>
